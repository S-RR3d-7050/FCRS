...
public class LogInSceneController implements Initializable {
    ...
    public void logIn(ActionEvent event) {
        ...
        // get customer
        Client client = customerDbUtil.logIn(emailTextField.getText(),
        ...
        if (client!=null) {
            ...
            //bankingSceneController.setClient(client); // TODO: CHANGE THIS IN REFERENCE.
    ...
    public void switchToRegisterScene(ActionEvent event) {
        try {
            ...
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(getClass().getResource("/c/app/RegisterScene.fxml"));
            Parent root = loader.load();
